    	...
    	<div class="intro">
            <div class="jumbotron row">
            	<div class="col-xs-6 col-sm-3 placeholder">
                    <img class="photo" src="/assets/images/1.gif"/>
                </div>
            ...
            <div class ="jumbotron row">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img class="photo" src="/assets/images/2.gif"/>
                </div>
                <div class="col-xs-6 col-sm-9 description">
            ...
            <div class="jumbotron row">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img class="photo" src="/assets/images/3.gif"/>
                </div>
                <div class="col-xs-6 col-sm-9 description">
            ...
            <div class="jumbotron row">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img class="photo" src="/assets/images/4.gif"/>
                </div>
                <div class="col-xs-6 col-sm-9 description">
            ...
            <div class="jumbotron row">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img class="photo" src="/assets/images/5.gif"/>
                </div>
                <div class="col-xs-6 col-sm-9 description">
            ...
            <div class="jumbotron row">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img class="photo" src="/assets/images/6.jpg"/>
                </div>
                <div class="col-xs-6 col-sm-9 description">
                    <p><b>Monica Li </b></p>
